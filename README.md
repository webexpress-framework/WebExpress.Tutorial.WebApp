...
- Add the necessary dependencies in the `WebApp` project file.
  ...
  <ItemGroup>
     <PackageReference Include="WebExpress.WebIndex" Version="2.0.0-alpha">
...
- Include the settings file in the `WebApp.App` project file.
